...
public class JsonAdaptedEventTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedEvent event =
                new JsonAdaptedEvent(INVALID_NAME, VALID_DESCRIPTION, VALID_DATE, VALID_NOTE, new ArrayList<>(), null);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedEvent event =
                new JsonAdaptedEvent(null, VALID_DESCRIPTION, VALID_DATE, VALID_NOTE, new ArrayList<>(), null);
    ...
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        JsonAdaptedEvent event =
                new JsonAdaptedEvent(VALID_NAME, INVALID_DESCRIPTION, VALID_DATE, VALID_NOTE, new ArrayList<>(), null);
    ...
    public void toModelType_nullDescription_throwsIllegalValueException() {
        JsonAdaptedEvent event =
                new JsonAdaptedEvent(VALID_NAME, null, VALID_DATE, VALID_NOTE, new ArrayList<>(), null);
