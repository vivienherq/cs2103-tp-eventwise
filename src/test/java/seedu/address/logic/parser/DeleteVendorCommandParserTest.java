...
public class DeleteVendorCommandParserTest {
    ...
    public void parse_validArgs_returnsDeleteVendorCommand() {
        String userInput = String.format(" %s%d", PREFIX_VENDOR, INDEX_FIRST_VENDOR.getOneBased());
        assertParseSuccess(parser, userInput, new DeleteVendorCommand(INDEX_FIRST_VENDOR));
    }
