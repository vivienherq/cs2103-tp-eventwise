...
/**
 * Finds and lists all events in EventWise whose name contains any of the argument keywords.
...
public class FindEventCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Finds all events whose names contain any of "
            ...
            + "Example: " + COMMAND_WORD + " FOC WellNUS SuperNOVA";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        return new CommandResult(
                String.format(Messages.MESSAGE_EVENTS_LISTED_OVERVIEW, model.getFilteredEventsList().size()));
    }
